  ...
  <div class="row">
    <div class="col-3 sidebar">
	 ...
	 <div class="col-9 main">
		...
		<form name="deptForm">
		전공 : 
		<input type="text" name="dept" size="30" placeholder="전공을 입력해주세요.">
		...
		Home > 아이디와 비밀번호 입력
		<hr>
		<form name="loginForm" action="datainput2.jsp"
			method="post" onsubmit="return checkFun1()">
			아이디 : <br>
			<input type="text" name="id" placeholder="아이디를 입력해주세요."><br><br>
			비밀번호 : <br>
			<input type="password" name="passwd" placeholder="비밀번호를 입력해주세요."><br><br>
